...
\begin{lstlisting}
wget https://github.com/kaushikchanchala/PINGALA/blob/main/CODES/pingala_1.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/kaushikchanchala/PINGALA/blob/main/CODES/pingala_2_1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
wget https://github.com/kaushikchanchala/PINGALA/blob/main/CODES/pingala_2_2.py
\end{lstlisting}
